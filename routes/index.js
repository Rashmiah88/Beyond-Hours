...
//Initialize the Razorpay instace
const razorpayInstance = new Razorpay({
  key_id: 'rzp_test_4Aq6Jnjtz9XMgG',
  key_secret: 'leLqdaIezWIkVx6YQxPDXTa1',
});
...
router.post('/cart/add', async (req, res) => {
    ...
    try {
        ...
        const cartProductIndex = req.session.cart.products.findIndex(p => p.productId.toString() === productId.toString());
